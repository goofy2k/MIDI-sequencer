...
#include <iostream>
#include "multitrack_dirty.h"  //FCKX
//#include "matrix.h"      //FCKX
...
//FCKX*** void DumpMIDITimedMessage (MIDITimedMessage* const msg, std::ostream& ost = std::cout);
...
//FCKX*** void CheckMIDIMatrix(const MIDIMatrix& matrix, std::ostream& ost = std::cout);
///@}
///@}
