...
/* STATIC */ void NimBLEDevice::init(const std::string &deviceName) {
    ...
    if(!initialized){
        ...
        */  
        ...
        ESP_LOGI(TAG, "Controller status A: %d", (int)esp_bt_controller_get_status() );
        esp_bt_controller_mem_release(ESP_BT_MODE_CLASSIC_BT);
        
        ESP_LOGI(TAG, "Controller status B: %d", (int)esp_bt_controller_get_status() );
        esp_bt_controller_config_t bt_cfg = BT_CONTROLLER_INIT_CONFIG_DEFAULT();
        ESP_LOGI(TAG, "Controller status C: %d", (int)esp_bt_controller_get_status() );
        ...
        ESP_LOGI(TAG, "Controller status D: %d", (int)esp_bt_controller_get_status() );

        ESP_ERROR_CHECK(esp_bt_controller_init(&bt_cfg)); 
        ESP_LOGI(TAG, "Controller status E: %d", (int)esp_bt_controller_get_status() );        
        ESP_LOGI(TAG, "NimBLEDevice::init E");              //**** this code NOT reached ****
        
        
        
        
        ESP_ERROR_CHECK(esp_bt_controller_enable(ESP_BT_MODE_BLE));
        ESP_LOGI(TAG, "Controller status F: %d", (int)esp_bt_controller_get_status() );       
        ESP_ERROR_CHECK(esp_nimble_hci_init());
        ESP_LOGI(TAG, "Controller status G: %d", (int)esp_bt_controller_get_status() );          
        nimble_port_init();
        ESP_LOGI(TAG, "Controller status H: %d", (int)esp_bt_controller_get_status() ); 
