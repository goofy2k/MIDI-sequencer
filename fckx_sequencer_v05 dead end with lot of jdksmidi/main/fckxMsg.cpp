#include "fckxMsg.h"
#include <cstdio>
#include <cstring>  //make these obsolete !  remove sprintf etc
...
/* MIDIClockTime */ long unsigned int MIDITimedMessage::GetTime() const
{
    return time;
}
...
void MIDITimedMessage::SetTime ( /* MIDIClockTime */ long unsigned int t )
{
    time = t;
}
...
/* MIDIClockTime */ long unsigned int MIDIDeltaTimedMessage::GetDeltaTime() const
{
    return dtime;
}
...
void MIDIDeltaTimedMessage::SetDeltaTime ( /* MIDIClockTime */ long unsigned int t )
{
    dtime = t;
}
...
void fckxMIDITimedMessage::Clear()
{
    timestamp = 0;
...
long unsigned int fckxMIDITimedMessage::GetTime() const
{
    return time;
}
...
void fckxMIDITimedMessage::SetTime (  long unsigned int t )
{
    time = t;
}
...
int  fckxMIDITimedMessage::CompareEvents (
    const fckxMIDITimedMessage &m1,
    const fckxMIDITimedMessage &m2
)
{
    bool n1 = m1.IsNoOp();
    bool n2 = m2.IsNoOp();
...
/* MIDIClockTime */ long unsigned int MIDIDeltaTimedBigMessage::GetDeltaTime() const
{
    return dtime;
}
...
void MIDIDeltaTimedBigMessage::SetDeltaTime ( /* MIDIClockTime */ long unsigned int t )
{
    dtime = t;
}
...
bool operator == ( const fckxMIDITimedMessage &m1, const fckxMIDITimedMessage &m2 )
{
    if ( m1.GetTime() != m2.GetTime() )
        return false;
