...
#include "RtMidi.h" //FCKX   phase out 
#include <NimBLEDevice.h> //FCKX phase in
...
class MidiOutNimBLE //: public MidiOutApi may need NimBLEDevice inheritance
{
 public:
  ...
  //      bool                    IsPortOpen() const              { return port->isPortOpen(); }
    ...
    protected:
       ...
       /// \cond EXCLUDED
        ...
        //NimBLEOut*              port;       // The hardware port should have a friend somewhere.....
        MidiOutNimBLE*              port; 
        //OR NimBLEOutDriver*  ??
